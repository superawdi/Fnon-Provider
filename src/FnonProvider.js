...
function FnonProvider(_ref3) {
  ...
  var createFullDialog = function createFullDialog(_ref4) {
  ...
  var createSimpleDialog = function createSimpleDialog(_ref5) {
  ...
  var showBackdrop = function showBackdrop(open) {
  ...
  var onSnackBarClose = function onSnackBarClose(id, callback) {
    setSnackbars(function (snaks) {
    ...
    if (callback && typeof callback === 'function') callback(); // setTimeout(() => {
  ...
  var contextValue = (0, _react.useRef)({
    ...
    createFullDialog: createFullDialog,
    createSimpleDialog: createSimpleDialog,
    clearDialogs: clearDialogs,
    showBackdrop: showBackdrop
  });
  return /*#__PURE__*/_react["default"].createElement(_FnonContext["default"].Provider, {
  ...
  })), backdrop.open && /*#__PURE__*/_react["default"].createElement(_core.Backdrop, {
    open: true,
    className: classes.backdrop
  }, /*#__PURE__*/_react["default"].createElement(_core.CircularProgress, {
    color: "inherit"
  }), backdrop.message && /*#__PURE__*/_react["default"].createElement(_Typography["default"], {
    color: "inherit",
    variant: "body1"
  }, backdrop.message)));
